...
@rem @set _ARATH_BIN_DIR=%_UTIL_DIR%/arath64/bin
...
@set _PYTHON_VERSION=3.8.8
@set _PYTHON_DIR=%_UTIL_DIR%/Python/
@set _PYTHON_INCLUDE_DIR=%_PYTHON_DIR%/include
@set _PYTHON_LIB=%_PYTHON_DIR%/libs/python38.lib
@rem @set _PYTHON_LIB=%_PYTHON_DIR%/libs/libpython38.a
...
@rem @set _COMPILER_NAME="AraBa Makefiles"
...
@set _BOOST_PYTHON_LIB=python38
@set _BOOST_NUMPY_LIB=numpy38
@rem @set _BOOST_LIB_DIR=%_LIBS_DIR%/boost_build/lib

@set PATH= 
@set PATH=%PATH%;C:/Windows/system32
@rem @set PATH=%PATH%;%_ARATH_BIN_DIR%
